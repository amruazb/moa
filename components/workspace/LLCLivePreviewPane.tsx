...
export function LLCLivePreviewPane() {
    ...
    const generatePDF = async () => {
        ...
        try {
            ...
            const opt = {
                margin: 0,
                filename: `LLC_MOA_${extractedData.company?.name || 'document'}.pdf`,
        ...
        <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-gray-50">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        <h3 className="text-sm font-semibold text-slate-900">LLC MOA Preview</h3>
                        <p className="text-[11px] text-slate-500">Multi-partner MOA • Auto-updates</p>
                    </div>
                </div>
                <div className="flex gap-2">
                    ...
                    <button
                        onClick={() => {
                            ...
                            a.href = url
                            a.download = `LLC_MOA_${extractedData.company?.name || 'document'}.html`
                            a.click()
