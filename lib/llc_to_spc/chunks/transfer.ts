    ...
    return `
      ...
      <div class="article-pair">
        <div class="block">
          ...
          <p>And the First Party owns <strong class="edited">${firstParty.sharesPercent}%</strong> shares, the Second Party owns <strong class="edited">${secondParty.sharesPercent}%</strong> shares, and the Third Party owns <strong class="edited">${thirdParty.sharesPercent}%</strong> shares from the total shares in the company's capital.</p>
          <p>Now the First Party, Second Party, and Third Party have agreed to assign and transfer all their shares (<strong class="edited">100%</strong>) to the Fourth Party, who shall become the sole owner of the company, converting it to a Sole Proprietorship LLC (LLC-SPC).</p>
        </div>
        <div class="block rtl">
          <h3 class="underline center">تمهيد</h3>
          <p>بما أن الطرف الأول والطرف الثاني والطرف الثالث يملكون الرخصة التجارية رقم: <strong class="edited">${license.licenseNumber}</strong>، الصادرة من <span class="edited">${license.issuingAuthorityAr}</span>، باسم: <strong class="edited">${license.oldCompanyNameAr}</strong> بموجب عقد التأسيس لشركة ذات مسؤولية محدودة المصدق من قبل الكاتب العدل برقم: <strong class="edited">${originalMOA.moaNumber}</strong> بتاريخ <strong class="edited">${originalMOA.moaDate}</strong>.</p>
          <p>والطرف الأول يملك <strong class="edited">${firstParty.sharesPercent}%</strong> من الحصص والطرف الثاني يملك <strong class="edited">${secondParty.sharesPercent}%</strong> من الحصص والطرف الثالث يملك <strong class="edited">${thirdParty.sharesPercent}%</strong> من الحصص من إجمالي حصص رأس مال الشركة.</p>
          <p>والآن قد اتفق الطرف الأول والطرف الثاني والطرف الثالث على التنازل ونقل جميع حصصهم (<strong class="edited">100%</strong>) إلى الطرف الرابع، الذي سيصبح المالك الوحيد للشركة، محولاً إياها إلى شركة الشخص الواحد ذات مسؤولية محدودة (ذ.م.م - ش.ش.و).</p>
        </div>
      </div>`
  }
}
    ...
    return `
      ...
      <div class="article-pair">
        <div class="block">
          ...
          <p>The First Party hereby assigns and transfers <strong class="edited">${firstParty.sharesPercent}%</strong> of the total shares in the company's capital to the Fourth Party.</p>
          <p>The Second Party hereby assigns and transfers <strong class="edited">${secondParty.sharesPercent}%</strong> of the total shares in the company's capital to the Fourth Party.</p>
          <p>The Third Party hereby assigns and transfers <strong class="edited">${thirdParty.sharesPercent}%</strong> of the total shares in the company's capital to the Fourth Party.</p>
          <p>The Fourth Party accepts this assignment and transfer, becoming the sole owner of <strong class="edited">100%</strong> of the company's capital.</p>
        </div>
        <div class="block rtl">
          <h3 class="underline center">المادة (1): التنازل عن الحصص</h3>
          <p>يتنازل الطرف الأول بموجب هذا العقد عن <strong class="edited">${firstParty.sharesPercent}%</strong> من إجمالي حصص رأس مال الشركة للطرف الرابع.</p>
          <p>يتنازل الطرف الثاني بموجب هذا العقد عن <strong class="edited">${secondParty.sharesPercent}%</strong> من إجمالي حصص رأس مال الشركة للطرف الرابع.</p>
          <p>يتنازل الطرف الثالث بموجب هذا العقد عن <strong class="edited">${thirdParty.sharesPercent}%</strong> من إجمالي حصص رأس مال الشركة للطرف الرابع.</p>
          <p>يقبل الطرف الرابع هذا التنازل والنقل، ليصبح المالك الوحيد لـ <strong class="edited">100%</strong> من رأس مال الشركة.</p>
        </div>
      </div>`
  }
}
  ...
  content: () => `
      ...
      <div class="article-pair">
        <div class="block">
          ...
          <p>The assignment and transfer of shares is made for the agreed consideration between the parties, which the First Party, Second Party, and Third Party acknowledge receipt of in full prior to the execution of this agreement.</p>
        </div>
        <div class="block rtl">
          <h3 class="underline center">المادة (2): المقابل</h3>
          <p>يتم التنازل ونقل الحصص مقابل المبلغ المتفق عليه بين الأطراف، والذي يقر الطرف الأول والطرف الثاني والطرف الثالث باستلامه كاملاً قبل توقيع هذا الاتفاق.</p>
        </div>
      </div>`
}
...
export const article3Chunk: ContentChunk = {
  ...
  estimatedHeight: 28,
  content: (ctx: LLCToSPCContext) => {
    const { newOwner, license } = ctx
    return `
      <!-- Article 3: Conversion to Sole Proprietorship -->
      <div class="article-pair">
        <div class="block">
          <h3 class="underline center">Article (3): Conversion to Sole Proprietorship LLC</h3>
          <p>Upon execution of this agreement, the company <strong class="edited">${license.companyName}</strong> shall be converted from a Limited Liability Company to a Sole Proprietorship LLC (LLC-SPC), with <strong class="edited">${newOwner.pronouns.title} ${newOwner.name}</strong> as the sole owner.</p>
        </div>
        <div class="block rtl">
          <h3 class="underline center">المادة (3): التحويل إلى شركة الشخص الواحد</h3>
          <p>عند تنفيذ هذا الاتفاق، يتم تحويل الشركة <strong class="edited">${license.companyNameAr}</strong> من شركة ذات مسؤولية محدودة إلى شركة الشخص الواحد ذات مسؤولية محدودة (ذ.م.م - ش.ش.و)، مع <strong class="edited">${newOwner.pronouns.titleAr}/ ${newOwner.nameAr}</strong> كمالك وحيد.</p>
        </div>
      </div>`
  }
}
