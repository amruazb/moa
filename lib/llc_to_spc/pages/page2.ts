...
export function page2(ctx: LLCToSPCContext, pageNum: number = 2): string {
  const { firstParty, secondParty, newOwner, license, originalMOA } = ctx
    ...
    <div class="page">
      ...
      <div class="article-pair">
        <div class="block">
          ...
          <p>Now the First Party and Second Party have agreed to assign and transfer all their shares (<strong class="edited">100%</strong>) to the Third Party (New Owner), who shall become the sole owner of the company, converting it to a Sole Proprietorship LLC (LLC-SPC).</p>
        </div>
        <div class="block rtl">
          ...
          <p>والآن قد اتفق الطرف الأول والطرف الثاني على التنازل ونقل جميع حصصهم (<strong class="edited">100%</strong>) إلى الطرف الثالث (المالك الجديد)، الذي سيصبح المالك الوحيد للشركة، محولاً إياها إلى شركة الشخص الواحد ذات مسؤولية محدودة (ذ.م.م - ش.ش.و).</p>
        </div>
      </div>
      ...
      <div class="article-pair">
        <div class="block">
          ...
          <p>The First Party hereby assigns and transfers <strong class="edited">${firstParty.sharesPercent}%</strong> of the total shares in the company's capital to the Third Party (New Owner).</p>
          <p>The Second Party hereby assigns and transfers <strong class="edited">${secondParty.sharesPercent}%</strong> of the total shares in the company's capital to the Third Party (New Owner).</p>
          <p>The Third Party (New Owner) accepts this assignment and transfer, becoming the sole owner of <strong class="edited">100%</strong> of the company's capital.</p>
        </div>
        <div class="block rtl">
          <h3 class="underline center">المادة (1): التنازل عن الحصص</h3>
          <p>يتنازل الطرف الأول بموجب هذا العقد عن <strong class="edited">${firstParty.sharesPercent}%</strong> من إجمالي حصص رأس مال الشركة للطرف الثالث (المالك الجديد).</p>
          <p>يتنازل الطرف الثاني بموجب هذا العقد عن <strong class="edited">${secondParty.sharesPercent}%</strong> من إجمالي حصص رأس مال الشركة للطرف الثالث (المالك الجديد).</p>
          <p>يقبل الطرف الثالث (المالك الجديد) هذا التنازل والنقل، ليصبح المالك الوحيد لـ <strong class="edited">100%</strong> من رأس مال الشركة.</p>
        </div>
      </div>
