  ...
  return `
    <div class="page">
      ...
      <div class="article-pair">
        <div class="block">
          <h3 class="underline center">Article (21): Financial Year</h3>
        ...
        <div class="block rtl">
          <h3 class="underline center">المادة (21): السنة المالية</h3>
      ...
      <div class="article-pair">
        <div class="block">
          <h3 class="underline center">Article (22): Transferring Company Shares</h3>
        ...
        <div class="block rtl">
          <h3 class="underline center">المادة (22): التصرف في الحصص</h3>
      ...
      <div class="article-pair">
        <div class="block">
          <h3 class="underline center">Article (23): Dissolution and Liquidation</h3>
        ...
        <div class="block rtl">
          <h3 class="underline center">المادة (23): حل الشركة وتصفيتها</h3>
