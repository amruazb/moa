  ...
  return `
    <div class="page">
      ...
      <div class="article-pair">
        <div class="block">
          <p><strong>(c)</strong> to act as an agent for the companies, establishments, international organizations and other legal entities in relation to the Company's objectives and to represent the same in the UAE and abroad;</p>
          <p><strong>(d)</strong> to enter into commercial and financial transactions, execute and implement contracts and other obligations, draw, accept and negotiate negotiable instruments, open and operate bank accounts and borrow money for any period of time with or without security on any or all of the assets of the Company, issue guarantees for itself and third parties, invest monies and deal with such investments on its own account and generally to institute, participate in or promote commercial and mercantile enterprises and activities in relation to or for the purpose of the business of the Company, and to do all such other things as may be considered to be incidental to or conducive to the above objects or any of them;</p>
          <p><strong>(e)</strong> to purchase, lease, or otherwise acquire, hold, develop, improve, manage, operate, sell, convey, transfer, or otherwise dispose of real and personal property of every kind and description;</p>
          <p><strong>(f)</strong> to engage in any lawful act or activity for which companies may be organized under the applicable laws and regulations of the UAE.</p>
        ...
        <div class="block rtl">
          <p><strong>(ج)</strong> العمل كوكيل للشركات والمؤسسات والمنظمات الدولية والكيانات القانونية الأخرى فيما يتعلق بأهداف الشركة وتمثيلها في دولة الإمارات العربية المتحدة وخارجها؛</p>
          <p><strong>(د)</strong> الدخول في معاملات تجارية ومالية، وتنفيذ العقود والالتزامات الأخرى، وسحب وقبول والتفاوض على الأوراق التجارية القابلة للتداول، وفتح وتشغيل حسابات مصرفية واقتراض الأموال لأي فترة زمنية مع أو بدون ضمان على أي أو جميع أصول الشركة، وإصدار ضمانات لنفسها وللأطراف الثالثة، واستثمار الأموال والتعامل مع هذه الاستثمارات لحسابها الخاص وبشكل عام إنشاء أو المشاركة في أو تعزيز المشاريع والأنشطة التجارية فيما يتعلق بأو لغرض أعمال الشركة، والقيام بجميع الأمور الأخرى التي قد تعتبر عرضية أو مؤدية إلى الأهداف المذكورة أعلاه أو أي منها؛</p>
          <p><strong>(هـ)</strong> شراء أو استئجار أو الحصول بأي طريقة أخرى على الممتلكات العقارية والشخصية من كل نوع ووصف، والاحتفاظ بها وتطويرها وتحسينها وإدارتها وتشغيلها وبيعها ونقلها أو التصرف فيها بأي طريقة أخرى؛</p>
          <p><strong>(و)</strong> الانخراط في أي عمل أو نشاط قانوني يمكن تنظيم الشركات من أجله بموجب القوانين واللوائح المعمول بها في دولة الإمارات العربية المتحدة.</p>
